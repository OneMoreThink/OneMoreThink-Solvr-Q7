import type { ReleaseData, ReleaseStats, ReleaseTrend, TopAuthor } from '../types/release';
...
export function getTopAuthors(data: ReleaseData[], limit: number = 5): TopAuthor[] {
...
export function getReleaseTrend(data: ReleaseData[]): ReleaseTrend {
